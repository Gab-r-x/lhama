...
def populate_db():
    ...
    new_project = Project(id=1, proj_name="Projeto_Teste_01", proj_desc="#Projeto_Desc_01", created_at=datetime(2024, 8, 19, 13, 0, 0), finished_at=datetime(2024, 8, 19, 15, 0, 0)),
